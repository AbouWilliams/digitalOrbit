...
$pages['2'] = "phones.php";
$pages['3'] = "audio.php";
$pages['4'] = "wearables.php";
$pages['5'] = "accessories.php";
$pages['6'] = "tablets.php";
$pages['7'] = "gaming.php";
$pages['8'] = "gadgets.php";
if (isset($_POST['visit'])) {
   $id = $_POST['category_id'];
   header("Location: categories/" . $pages[$id]);
}
  ...
  <div class="catalog-container">
    <div class="catalog-content">
      <div class="catalog-header">
        <h1 class="catalog-title">Product Categories</h1>
...
<div class="product-grid">
  ...
  <div class="product-card">
    ...
    <div class="product-details">
      <h3 class="product-name"><?= htmlspecialchars($category['name']) ?></h3>
      <div class="product-actions">
<form method="post">
<input hidden name="category_id" type="text" value="<?= $category['category_id'] ?>">
      <button class="see-items" type="submit" name="visit">See Items</button>
</form>
      </div>
    </div>
  </div>
